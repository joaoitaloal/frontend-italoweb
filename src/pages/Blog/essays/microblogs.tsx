...
function Microblogs(){
    ...
    return <div id={style.blog}>
        <h1>Mini texto de apreciação aos pequenos sites pessoais</h1>
        ...
        <p><a href="https://terribleideas.me/">https://terribleideas.me/</a> Esse é um blog pessoal de um cara, não lembro como cheguei nele mas tava nas minhas janelas abertas então entrou aqui. [Voltando depois de alguns meses que escrevi isso pra avisar que esse caiu :(, adoraria dar uma lembrança do que tinha nele mas não lembro, vou deixar o link aí por que a verdade é que esse tipo de coisa acontece e incontáveis sites incriveis somem todo dia, então fica de recordação que um dia esse site existiu e provavelmente era bem legal pra ter entrado na lista.]</p>
